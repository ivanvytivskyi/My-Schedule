    ...
    orderedDays.forEach(({ date }, i) => {
        ...
        if (isWorkDay) {
            ...
            if (!isNaN(shiftStart) && !isNaN(shiftEnd)) {
                ...
                const maxGapBeforeShift = maxGapInWindow(blocks, 0, shiftStart);
                const maxGapAfterShift = maxGapInWindow(blocks, shiftEnd, dayEndMinutes);
                ...
                blocks = blocks.filter(block => {
                    ...
                    if (dinner && !keepDinner) return false;
                    return true;
                });
            }
        }
