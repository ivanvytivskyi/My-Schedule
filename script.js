    ...
    let html = `
        <div class="time-block" data-time="${block.time}" data-day="${dayKey}" data-index="${index}">
            ...
            <div class="title">
                ...
                ${block.recipeID ? `
                    <div class="recipe-chip" style="display:inline-flex;align-items:center;gap:6px;margin-left:8px;padding:4px 10px;border-radius:999px;background:#f0f4ff;color:#364152;font-size:12px;font-weight:600;vertical-align:middle;">
