    ...
    return new Promise((resolve) => {
        ...
        const renderSlots = () => {
            ...
            slotsList.innerHTML = availableSlots.map((slot, idx) => {
                ...
                const minStartMins = slot.windowStartMins + sanitizedTravel;
                const maxStartMins = slot.windowEndMins - sanitizedShop - sanitizedTravel;
                ...
                return `
                    <label style="display: block; padding: 12px; margin-bottom: 8px; 
                        ...
                        <br>
                        <small style="color: #059669; margin-left: 26px;">Choose start time:</small>
