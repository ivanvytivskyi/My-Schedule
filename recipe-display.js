...
function generateShoppingListFromRecipes(options = {}) {
    ...
    const blocksHtml = allRecipes.map(recipe => {
        ...
        return `
            <div class="shopping-list-block" data-shop="${recipeName}" data-source="recipes" style="margin-bottom: 16px; page-break-inside: avoid; border: 2px solid #c7d2fe; border-radius: 12px; overflow: hidden; background: linear-gradient(180deg, #f8fafc 0%, #eef2ff 100%); box-shadow: 0 6px 14px rgba(55, 65, 81, 0.08);">
