...
function generateShoppingListFromRecipes() {
    ...
    allRecipes.forEach(recipe => {
        ...
        recipe.quickAddItems.forEach(item => {
            ...
            const neededInBase = typeof convertUnitsToTarget === 'function'
        ...
        if (match) {
            ...
            let availableUnits = match.unlimited
                ...
                : typeof match.qtyUnits === 'number'
                    ? (typeof convertUnitsToTarget === 'function' ? convertUnitsToTarget(match.qtyUnits, matchUnit, baseUnit) : match.qtyUnits)
