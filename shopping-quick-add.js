    ...
    Object.keys(CANONICAL_PRODUCTS).forEach(canonicalKey => {
        ...
        Object.keys(product.shops).forEach(shopName => {
            ...
            if (product.category) {
                ...
                category = 'Meat & Fish';
            } else if ((keyLower.includes('bread') || keyLower.includes('croissant') || keyLower.includes('tortilla') || keyLower.includes('roll') || keyLower.includes('bagel') || keyLower.includes('bap') || keyLower.includes('bun')) && !keyLower.includes('rolled_oats')) {
